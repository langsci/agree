...
\abstract{
\noindent Based on the assumption that all cases of long distance
...
\Lsciexi. \label{4}
\ag.  Na netxa-in [$\alpha$ kma je\textipa{B}na-s~] \\
     he forget-{{\scshape 3sg.subj(intrans)}} {} me meet-{\sc inf} \\
      `He forgot to meet me.'
\bg.  Na \textipa{@}ntxa-\textipa{B}um=nm [$\alpha$ kma je\textipa{B}na-s~] \\
...
Like \scite{'s}{Boskovic:07} approach, \scite{'s}{Bhatt:05} analysis is
    based on a revised Agree operation -- in this case, it is one which also is not
 subject to the {\it Activity Condition}, but which does respect the PIC.
...
\scite{'s}{Bhatt:05} analysis may work well for a language like Hindi,
...
\excite{791}{Bhatt:05} ultimately concludes that a feeding account of
...
Against this background, \scite{'s}{Polinsky&Potsdam:01} proposal is
...
More specifically, \scite{'s}{Polinsky&Potsdam:01} analysis works as
follows. 
...
(\excite{627}{Polinsky&Potsdam:01}), but not, say, the specifier of
...
(\excite{638}{Polinsky&Potsdam:01}). Note  that this presupposes that
...
a designated C element.\footnote{\label{whabs}As noted by
  \excite{fn. 20}{Polinsky&Potsdam:01}, long-distance agreement in the
  presence of a 
...
These qualifications notwithstanding, \scite{'s}{Polinsky&Potsdam:01}
...
All  that said, \excite{626}{Polinsky&Potsdam:01} would seem to 
...
\scite{'s}{Polinsky&Potsdam:01} assumption that a DP embedded under a factive verb
...
\bg. U\v{z}a-l l/b-iq'-\v{s}e \label{17-b}k\textsuperscript{\textipa{Q}}aba zihe b-ot'uq'q'-u \\
...
raised by \scite{'s}{Polinsky&Potsdam:01} analysis of {\it {\l}i}
...
derivation (as \scite{'s}{Polinsky&Potsdam:01} approach, where
...
Given  \scite{'s}{Chomsky:01} {\it Activity Condition}, after $\phi$-Agree
...
embedded clause are generated by Merge and Agree operations, while V$\_$1 moves up
  ...
  shown in \Next.\footnote{The mechanics here are similar to 
   \scite{'s}{Martinovic:15} analysis of the left periphery of Wolof
...
The resulting representation is opaque in \scite{'s}{Kiparsky:73:abs}
sense as it involves a counter-bleeding interaction of operations
(also cf.  \cite{Chomsky:51}, \excite{25-26}{Chomsky:75:the}):
...
been reached. There is one qualification, though. 
 ...
 DP$\_${int} is
  transported into the matrix clause.\footnote{Note that this implies
    that {\it discharged} features, while syntactically inert, are not
...
accounted for concerns \scite{'s}{Polinsky&Potsdam:01} observation
...
\scite{'s}{Baker:88} sense, conceived of as incorporation at LF that

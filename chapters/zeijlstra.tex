...
\exbox{\forestset{pretty nice empty nodes/.style={
		...
		\begin{forest}	
			[F$\cup$G, pretty nice empty nodes
			[F]
			[G] ]
		\end{forest}}
	\end{exe}
...
\node [below] at (1.3,0.2) {{\lbrack}uF{\rbrack}};
\draw [black] (3.61,1.8) -- (3.61,.8);
\node [below] at (3.6,0.2) {{\lbrack}iF{\rbrack}};
\draw [black] (6.22,1.8) -- (6.22,.8);
\node [below] at (6.25,0.2) {{\lbrack}S{\rbrack}};
\end{tikzpicture}
\end{exe}
\end{figure}
\begin{figure}[!h]
...
\draw (9,2) ellipse (3cm and 1cm);
\node [right] at (8,2) {\huge{\textbf{.}}};
\node [below] at (0.75,0.2) {{\lbrack}uF{\rbrack}};
\draw [black] (3,1.8) -- (3,.8);
\node [below] at (3.05,0.2) {{\lbrack}iF{\rbrack}};
\draw [black] (8.23,1.8) -- (8.23,.8);
\node [below] at (8.28,0.2) {{\lbrack}S{\rbrack}};
\end{tikzpicture}
\end{exe}
\end{figure}
...
\begin{figure}[!h]
	\begin{exe}
		...
		\begin{forest}	
			[\{{\lbrack}F{\rbrack}\}, pretty nice empty nodes
			[\{{\lbrack}F{\rbrack}{,} {\lbrack}uG{\rbrack}\}]
			[\{{\lbrack}G{\rbrack}\}] ]
		\end{forest}}
	\end{exe}
\end{figure}
...
\begin{figure}[!h]
	\begin{exe}
		...
		\begin{forest}	
			[\{{\lbrack}F{\rbrack}{,} {\lbrack}uK{\rbrack}\}, pretty nice empty nodes
			[\{{\lbrack}F{\rbrack}{,} {\lbrack}uG{\rbrack}\}]
			[\{{\lbrack}G{\rbrack}{,} {\lbrack}uK{\rbrack}\}] ]
		\end{forest}}
	\end{exe}
\end{figure}
...
\begin{figure}[!h]
	\begin{exe}
		...
		\begin{forest}	
			[*\{{\lbrack}F{\rbrack}{,} {\lbrack}G{\rbrack}\}, pretty nice empty nodes
			[\{{\lbrack}F{\rbrack}\}]
			[\{{\lbrack}G{\rbrack}\}] ]
		\end{forest}}
	\end{exe}
...
\begin{figure}[!h]
	\begin{exe}
		\exbox{\forestset{pretty nice empty nodes/.style={
			...
			\begin{forest}	
				[\{{\lbrack}Y{\rbrack}\}, pretty nice empty nodes
				[\{{\lbrack}X{\rbrack}\}]
				[\{{\lbrack}Y{\rbrack}{,} {\lbrack}uX{\rbrack}\}] ]
		\end{forest}}
	\end{exe}
\end{figure} 
...
\begin{figure}[!h]
	\begin{exe}
		\exbox{\forestset{pretty nice empty nodes/.style={
			...
			\begin{forest}	
				[\{{\lbrack}\textbf{V}{\rbrack}\}, pretty nice empty nodes
				[\{{\lbrack}V{\rbrack}\}]
				[\{{\lbrack}\textbf{V}{\rbrack}{,} {\lbrack}uV{\rbrack}\}] ]
		\end{forest}}
	\end{exe}
\end{figure} 
...
\begin{figure}[!h]
	\begin{exe}
		\exbox{\forestset{pretty nice empty nodes/.style={
			...
			\begin{forest}	
				[PP{=}\{{\lbrack}V{\rbrack}{,} {\lbrack}uV{\rbrack}\}, pretty nice empty nodes
				[P{=}\{{\lbrack}V{\rbrack}{,} {\lbrack}uV{\rbrack}{,} {\lbrack}uD{\rbrack}\}]
				[DP{=}\{{\lbrack}D{\rbrack}\}] ]
		\end{forest}}
	\end{exe}
\end{figure} 
...
\begin{figure}[!h]
	\begin{exe}
		\exbox{\forestset{pretty nice empty nodes/.style={
			...
			\begin{forest}	
				[VP{=}\{{\lbrack}V{\rbrack}{,} {\lbrack}uV{\rbrack}\}, pretty nice empty nodes
				[VP{=}\{{\lbrack}V{\rbrack}\}]
				[PP{=}\{{\lbrack}V{\rbrack}{,} {\lbrack}uV{\rbrack}\}
				[P{=}\{{\lbrack}V{\rbrack}{,} {\lbrack}uV{\rbrack}{,} {\lbrack}uD{\rbrack}\}]
				[DP{=}\{{\lbrack}D{\rbrack}\}] ] ]
		\end{forest}}
	\end{exe}
...
\begin{figure}[!h]
	\begin{exe}
		\exbox{\forestset{pretty nice empty nodes/.style={
			...
			\begin{forest}	
				[VP{=}\{{\lbrack}V{\rbrack}\}, pretty nice empty nodes
				[DP{=}\{{\lbrack}D{\rbrack}\}]
	...
	\end{exe}
\end{figure} 
\newpage \noindent But this prediction is indeed correct. It is well known that many languages exhibit so-called particle-verb constructions, where a combination of a preposition and a verb yield a complex verb. Examples are in (24) below.

\begin{exe}
	\ex Particle-verb constructions
	\xlist
	\ex {\lbrack}\textsubscript{V'} \textit{eat up} {\lbrack}\textsubscript{DP} \textit{the sandwich}{\rbrack}{\rbrack}
	\ex {\lbrack}\textsubscript{CP} \textit{Ich rufe}\textsubscript{i} {\lbrack}\textsubscript{VP} \textit{Marie an} t\textsubscript{i}{\rbrack}{\rbrack}
	\endxlist
\end{exe}
According to Van \citet{Riemsdijk1978}, \citet{Baker1988}, \citet{Koopman1995}, Neeleman (1994, 2002), and \citet{Zeller2001}, among many others, particle verbs are complex verbal heads. In particular, \citet{Zeller2001} argues that particle verbs are complex heads where the verbal subfeatures of the verb do not percolate to the verb–particle complex. This is motivated by examples like (24b): why would the C-head not target the complex but closer V \textit{an-rufe}, instead of the more deeply embedded \textit{rufe}? Under the assumption that C targets a finite verb and that the finite features under V do not percolate up to the head of the verbal complex, this pattern becomes clear. \textit{Rufe} is the closest finite verb, and therefore raises to C.
...
\begin{figure}[!h]
	\begin{exe}
		\exbox{\forestset{pretty nice empty nodes/.style={
			...
			\begin{forest}	
				[V{=}\{\textbf{{\lbrack}V{\rbrack}}{,} \textbf{{\lbrack}uD{\rbrack}}\}, pretty nice empty nodes
				[P{=}\{\textbf{{\lbrack}V{\rbrack}}{,} {\lbrack}uV{\rbrack}{,} \textbf{{\lbrack}uD{\rbrack}}\}]
				[V{=}\{{\lbrack}V: Fin{\rbrack}\}] ]
		\end{forest}}
	\end{exe}
\end{figure} 
	...
	\begin{exe}
		\exbox {\forestset{pretty nice empty nodes/.style={
			...
			\begin{forest}	for tree={align=center}
				[VP{=}\{{\lbrack}V{\rbrack}\}, pretty nice empty nodes
				[DP\\ \textit{Mary}]
				[VP{=}\{{\lbrack}V{\rbrack}{,} {\lbrack}uD{\rbrack}\}
				[VP{=}\{{\lbrack}V{\rbrack}{,} {\lbrack}uD{\rbrack}\}\\ \textit{count}]
				[PP{=}\{{\lbrack}V{\rbrack} {,} {\lbrack}uV{\rbrack}\}
				[P{=}\{{\lbrack}V{\rbrack}{,} {\lbrack}uV{\rbrack}\}{,} {\lbrack}uD{\rbrack}\}\\ \textit{on} ]
				[DP{=}\{{\lbrack}D{\rbrack}\}\\ \textit{her parents}]
				] ] ] 
		\end{forest}}
	\end{exe}
\end{figure} 
	...
	\begin{exe}
		\exbox{\forestset{pretty nice empty nodes/.style={
			...
			\begin{forest}	for tree={align=center}
				[VP{=}\{{\lbrack}V{\rbrack}\}, pretty nice empty nodes
				[VP{=}\{{\lbrack}V{\rbrack}\}
				[DP{=}\{{\lbrack}D{\rbrack}\}\\ \textit{Mary}]
				[VP{=}\{{\lbrack}V{\rbrack}{,} {\lbrack}uD{\rbrack}\}\\ \textit{count}] ]
				[PP{=}\{{\lbrack}V{\rbrack}{,} {\lbrack}uV{\rbrack}\} \\ \textit{on the kitchen table}] ] 
		\end{forest}}
	\end{exe}
\end{figure} \newpage
	...
	\begin{exe}
		\exbox{\forestset{pretty nice empty nodes/.style={
			...
			\begin{forest}	for tree={align=center}
				...
				[VP{=}\{{\lbrack}V{\rbrack}\} 
				[V{=}\{{\lbrack}V{\rbrack}{,} {\lbrack}uD{\rbrack}\}\\\textit{kiss}]
				[DP{=}\{{\lbrack}D{\rbrack}\}\\ \textit{John}]
				] ] ] 
		\end{forest}}
	\end{exe}
\end{figure}
...
\begin{figure}[!h]
	\begin{exe}
		\exbox{\forestset{pretty nice empty nodes/.style={
			...
			\begin{forest}	
				[v'{=}\{{\lbrack}uD{\rbrack}\}, pretty nice empty nodes
				[v{=}\{{\lbrack}v{\rbrack}{,} {\lbrack}uV{\rbrack}{,} {\lbrack}uD{\rbrack}\}]
				[VP{=}\{{\lbrack}V{\rbrack}{,} {\lbrack}uv{\rbrack}\}
				[V{=}\{{\lbrack}V{\rbrack}{,} {\lbrack}uD{\rbrack}\}]
				[DP{=}\{{\lbrack}D{\rbrack}{,} {\lbrack}uv{\rbrack}\}]
				] ] 
		\end{forest}}
	\end{exe}
\end{figure}
...
\begin{figure}[!h]
	\begin{exe}
		\exbox{\forestset{pretty nice empty nodes/.style={
			...
			\begin{forest} for tree={align=center}	
				[{\lbrack}Pred{\rbrack}, pretty nice empty nodes
				[{\lbrack}Pred: V{\rbrack}\\ {=} {\lbrack}V{\rbrack}]
				[{\lbrack}Pred: N{\rbrack}\\ {=} {\lbrack}N{\rbrack}]
				] 
		\end{forest}}
	\end{exe}
\end{figure} 
...
\ex	Samoan 
	...
	\endxlist
	\end{exe}}
Even though this argumentation is far from uncontroversial (see, for instance \citealt{Croft2005}), various scholars (\citealt{Hengeveld1992}, 2005; Mosel and \citealt{Hovdhaugen1992}; \citealt{Gil2013}; and \citealt{Zeijlstra2017}) take this as evidence that not every language exhibits a noun–verb distinction, but may rather display elements of this lexical supercategory (sometimes also called ‘contentives’).
	...
	\begin{exe}
		\exbox{ \forestset{pretty nice empty nodes/.style={
			...
			\begin{forest}for tree={grow=north}, for tree={align=center}
				[\{{\lbrack}V{\rbrack}\}, pretty nice empty nodes	
				[\textit{in the park}\\ \{{\lbrack}Pred{\rbrack}{,} {\lbrack}uPred{\rbrack}\}\\  \{{\lbrack}Pred: V{\rbrack}{,} {\lbrack}uPred: V{\rbrack}\}\\ \{{\lbrack}V{\rbrack}{,} {\lbrack}uV{\rbrack}\}]
				[\textit{meet Mary}\\ \{{\lbrack}V{\rbrack}\}\\ \{{\lbrack}V{\rbrack}\}\\ \{{\lbrack}V{\rbrack}\}] ]
		\end{forest}}
	\end{exe}
\end{figure}
...
\begin{figure}[!h]
	\begin{exe}
		\exbox{ \forestset{pretty nice empty nodes/.style={
			...
			\begin{forest}for tree={grow=north}, for tree={align=center}
				[\{{\lbrack}N{\rbrack}\}, pretty nice empty nodes	
				[\textit{in the park}\\ \{{\lbrack}Pred{\rbrack}{,} {\lbrack}uPred{\rbrack}\}\\  \{{\lbrack}Pred: N{\rbrack}{,} {\lbrack}uPred: N{\rbrack}\}\\ \{{\lbrack}N{\rbrack}{,} {\lbrack}uN{\rbrack}\}]
				[\textit{man}\\ \{{\lbrack}N{\rbrack}\}\\ \{{\lbrack}N{\rbrack}\}\\ \{{\lbrack}N{\rbrack}\}] ]
		\end{forest}}
	\end{exe}
\end{figure} 
...
\begin{figure}[!h]
	\begin{exe}
		\exbox{ \forestset{nice empty nodes/.style={for tree={calign=fixed edge angles}, delay={where content={}{shape=coordinate, for current and siblings={anchor=north}}{}}
			...
			\begin{forest}	for tree={align=center}
				[\{{\lbrack}D{\rbrack}\}, nice empty nodes
				[\{{\lbrack}D{\rbrack}{,} {\lbrack}uN{\rbrack}\}\\ \textit{the}]
				[\{{\lbrack}N{\rbrack}\}\\ \textit{cat}] ]
		\end{forest}}
	\end{exe}
\end{figure}
	...
	\begin{exe}
		\exbox{ \forestset{nice empty nodes/.style={for tree={calign=fixed edge angles}, delay={where content={}{shape=coordinate, for current and siblings={anchor=north}}{}}
			...
			\begin{forest}	for tree={align=center}
				...
				[\{{\lbrack}D{\rbrack}{,} {\lbrack}uN{\rbrack}\}\\ \textit{the}]
				[\{{\lbrack}N{\rbrack}\}
				[\{{\lbrack}N{\rbrack}{,} {\lbrack}uN{\rbrack}\}\\ \textit{obnoxious}]
				[\{{\lbrack}N{\rbrack}\}\\ \textit{cat}] ] ] 
		\end{forest}}
	\end{exe}
\end{figure}
...
In various languages, predicatively and attributively used adjectives, however, do receive different forms. In Dutch and German, for instance, attributively used adjectives are affixed by an inflectional marker (that agrees in number, gender, and definiteness with the noun and the determiner), whereas predicatively used adjectives are not, as is shown for Dutch in (40) below: 
...
\begin{figure}[!h]
	\begin{exe}
		\exbox{ \forestset{nice empty nodes/.style={for tree={calign=fixed edge angles}, delay={where content={}{shape=coordinate, for current and siblings={anchor=north}}{}}
			...
			\begin{forest}	for tree={align=center}
				[\{{\lbrack}D{\rbrack}\}, nice empty nodes
				[\{{\lbrack}D{\rbrack}{,} {\lbrack}uN{\rbrack}\}\\ \textit{het}]
				[\{{\lbrack}N{\rbrack}\}
				[\{{\lbrack}N{\rbrack}{,} {\lbrack}uN{\rbrack}\}
				[\{{\lbrack}Pred{\rbrack}\}\\ \textit{mooi}]
				[\{{\lbrack}uPred{\rbrack}{,} {\lbrack}N{\rbrack}{,} {\lbrack}N{\rbrack}\}\\ \textit{-e}] ] 
				[\{{\lbrack}N{\rbrack}\}\\ \textit{huis}] ] ] 
		\end{forest}}
	\end{exe}
\end{figure}
...
\ex Dutch
	...
	\glt ‘The doctor is in love with her patient.’     
	\ex
	\gll *de verliefd(-e) op haar patient dokter \\
		the doctor in.love on her patient  \\
	\glt Int. ‘the doctor who is in love with her patient’  
	\endxlist
\end{exe}}
	...
	\begin{exe}
		\exbox{\forestset{pretty nice empty nodes/.style={
			...
			\begin{forest}	for tree={align=center}, for tree= pretty nice empty nodes
				[C{'}{=}\{{\lbrack}C{\rbrack}{,} {\lbrack}uW{\rbrack}\}
				[C{=}\{{\lbrack}C{\rbrack}{,} {\lbrack}Q{\rbrack}{,} {\lbrack}uT{\rbrack}{,}  {\lbrack}uWh{\rbrack}\}]
				[TP{=}\{{\lbrack}T{\rbrack}{,} {\lbrack}uQ{\rbrack}\}
				[DP{:}\{{\lbrack}D{\rbrack}\}]
				[T{'}{=}\{{\lbrack}T{\rbrack}{,} {\lbrack}uD{\rbrack}{,} {\lbrack}uQ{\rbrack}\}
				[T{'}{=}\{{\lbrack}T{\rbrack}{,} {\lbrack}uV{\rbrack}{,} {\lbrack}uD{\rbrack}\}]
				[VP{=}\{{\lbrack}V{\rbrack}{,} {\lbrack}uQ{\rbrack}\}
				[...V{=}\{{\lbrack}V{\rbrack}{,} {\lbrack}uD{\rbrack}\} \hspace{1cm} DP{=}\{{\lbrack}D: Wh{\rbrack}{,} {\lbrack}uQ{\rbrack}\}, roof]
				] ] ] ] 
		\end{forest}}
	\end{exe}
\end{figure}
...
\begin{figure}[!h]
	\begin{exe}
		\exbox{\forestset{pretty nice empty nodes/.style={
			...
			\begin{forest}	for tree={align=center}, for tree= pretty nice empty nodes
				[CP{=}\{{\lbrack}uWh{\rbrack}\}
				[DP{=}\{{\lbrack}D: Wh{\rbrack}\}]
				[C{'}{=}\{{\lbrack}C{\rbrack}{,} {\lbrack}uWh{\rbrack}\}
				[C{=}\{{\lbrack}C{\rbrack}{,} {\lbrack}Q{\rbrack}{,} {\lbrack}uWh{\rbrack}{,}  {\lbrack}uT{\rbrack}\}]
				[TP{=}\{{\lbrack}T{\rbrack}{,} {\lbrack}uQ{\rbrack}\}
				[DP{=}\{{\lbrack}D{\rbrack}\}]
				[T{'}{=}\{{\lbrack}T{\rbrack}{,} {\lbrack}uD{\rbrack}{,} {\lbrack}uQ{\rbrack}\}
				[T{'}{=}\{{\lbrack}T{\rbrack}{,} {\lbrack}uV{\rbrack}{,} {\lbrack}uD{\rbrack}\}]
	...
	\begin{exe}
		\exbox{\forestset{pretty nice empty nodes/.style={
			...
			\begin{forest}	for tree={align=center}
				...
				[DP{=}\{{\lbrack}D{\rbrack}\}]
				[T{'}{=}\{{\lbrack}T{\rbrack}{,} {\lbrack}uD{\rbrack}\}
				[T{=}\{{\lbrack}Fin{\rbrack}{,} {\lbrack}T{\rbrack}{,} {\lbrack}uV{\rbrack}{,} {\lbrack}uD{\rbrack}\}]
				[vP{=}\{{\lbrack}V{\rbrack}{,} {\lbrack}uFin{\rbrack}\}
				[DP{=}\{{\lbrack}D{\rbrack}\}]
				[v{'}{=}\{{\lbrack}V{\rbrack}{,} {\lbrack}uD{\rbrack}{,} {\lbrack}uFin{\rbrack}\}
				[v{=}\{{\lbrack}V{\rbrack}{,} {\lbrack}uV{\rbrack}{,} {\lbrack}uD{\rbrack}\}]
				[VP{=}\{{\lbrack}V{\rbrack}{,} {\lbrack}uFin{\rbrack}\}
				[V{:}\{{\lbrack}V{\rbrack}{,} {\lbrack}uD{\rbrack}\}]
				[DP{:}\{{\lbrack}D{\rbrack}{,} {\lbrack}uFin{\rbrack}\}]
				] ] ] ] ] 
		\end{forest}}
	\end{exe}
\end{figure}
...
\begin{figure}[!h]
	\begin{exe}
		\exbox{ \forestset{pretty nice empty nodes/.style={
			...
			\begin{forest}	for tree={align=center}
				[\{{\lbrack}V{\rbrack}\}, pretty nice empty nodes
				[\{{\lbrack}V{\rbrack}{,} {\lbrack}uD{\rbrack}\}\\ \textit{like}]
				[\{{\lbrack}D{\rbrack}\}
				[\{{\lbrack}D{\rbrack}{,} {\lbrack}uN{\rbrack}\}\\ \textit{the}]
				[\{{\lbrack}N{\rbrack}\}\\ \textit{cat}]
				] ] 
	...
	\end{exe}
\end{figure}
\newpage \noindent Given the feature architecture, another configuration that is incorrectly predicted to be grammatical is the structure in (50):
...
\begin{figure}[!h]
	\begin{exe}
		\exbox{ \forestset{pretty nice empty nodes/.style={
			...
			\begin{forest}	for tree={align=center}
				[\{{\lbrack}V{\rbrack}\}, pretty nice empty nodes
				[\{{\lbrack}N{\rbrack}\}\\ \textit{cat}]
				[\{{\lbrack}V{\rbrack}{,} {\lbrack}uN{\rbrack}\}
				[\{{\lbrack}V{\rbrack}{,} {\lbrack}uD{\rbrack}\}\\ \textit{like}]
				[\{{\lbrack}D{\rbrack}{,} {\lbrack}uN{\rbrack}\}\\ \textit{the}]
				] ] 
		\end{forest}}
	\end{exe}
\end{figure}
\noindent Instead of trying to account for this in semantic terms (which would be far from trivial), it may be more intuitive to rule out (50) under valuation. Generally, determiners agree with the nouns they combine with in person, number and gender (or a subset thereof). Presuming that nouns are equipped with such features (which, at least for the case of gender, is fairly uncontroversial), the noun should value the [D]-feature of the determiner. This is indeed possible under sisterhood in (49), but not in (50). To see this, let’s include feature-(un)valuedness in these trees, which is shown in (51) and (52) (where [D: \ul{}\textsubscript{$\varphi$}] means that the [D]-feature needs to be valued for $\varphi$-features). Here, I will assume that all $\varphi$-features start out on N, though there is nothing crucial that hinges on that. (51) is what the tree looks like before valuation, and (52) after valuation.
...
\begin{figure}[!h]
	\begin{exe}
		\exbox{\forestset{pretty nice empty nodes/.style={
			...
			\begin{forest}	for tree={align=center}
				[\{{\lbrack}D:\ul{} \textsubscript{$\varphi$}{\rbrack}\}, pretty nice empty nodes
				[\{{\lbrack}D:\ul{} \textsubscript{$\varphi$}{\rbrack}{,} {\lbrack}uN{\rbrack}\}\\ \textit{the}]
				[\{{\lbrack}N: 3{,} SG{\rbrack}\}\\ \textit{cat}]
				]  
		\end{forest}}
	\end{exe}
\end{figure}
\begin{figure}[!h]
	\begin{exe}
		\exbox{\forestset{pretty nice empty nodes/.style={
			...
			\begin{forest}	for tree={align=center}
				[\{{\lbrack}D: 3{,} SG{\rbrack}\}, pretty nice empty nodes
				[\{{\lbrack}D: 3{,} SG{\rbrack}{,} {\lbrack}uN{\rbrack}\}\\ \textit{the}]
				[\{{\lbrack}N: 3{,} SG{\rbrack}\}\\ \textit{cat}]
				]  
		\end{forest}}
	\end{exe}
\end{figure}
\newpage \noindent
There is no straightforward way in which, in a tree like (53) (based on the one in (50)), the unvalued feature [D: \ul{}\textsubscript{$\varphi$}] on D can be valued under sisterhood. The structure will consequently be ruled out:
...
\exbox{\forestset{pretty nice empty nodes/.style={
	...
	[\{{\lbrack}D: 3{,} SG{\rbrack}\}, pretty nice empty nodes
	[\{{\lbrack}D:\ul{}\textsubscript{$\varphi$}{\rbrack}{,} {\lbrack}uN{\rbrack}\}\\ \textit{the}]
	[\{{\lbrack}N: 3{,} SG{\rbrack}\}
	[\{{\lbrack}N:\ul{}\textsubscript{$\varphi$}{\rbrack}{,} {\lbrack}uN{\rbrack}\}\\ \textit{angry}]
	[\{{\lbrack}N: 3{,} SG{\rbrack}\}\\ \textit{cat}]
	] ]  
	\end{forest}}
\end{exe}
...
\exbox{\forestset{pretty nice empty nodes/.style={
	...
	\begin{forest}	for tree={align=center}
	[\{{\lbrack}uN{\rbrack}{,} {\lbrack}N:\ul{}\textsubscript{$\varphi$}{\rbrack}\}, pretty nice empty nodes
	[\{{\lbrack}uN:\ul{}\textsubscript{$\varphi$}{\rbrack}{,} {\lbrack}N:\ul{}\textsubscript{$\varphi$}{\rbrack}\\ \textit{very}]
	[\{{\lbrack}uN{\rbrack}{,} {\lbrack}N:\ul{}\textsubscript{$\varphi$}{\rbrack}\}\\ \textit{angry}] 
	]
	\end{forest}}
\end{exe}
\end{figure}
